...
class GroupableTableHeaderUI extends BasicTableHeaderUI {
    ...
    private Map<Integer, TableCellRenderer> readers = new HashMap<Integer, TableCellRenderer>();


    public TableCellRenderer getRender(int columIndex) {
        return readers.get(columIndex);
    }

    private void paintCell(Graphics g, final Rectangle cellRect, int columnIndex) {
        TableColumnModel columnModel = header.getColumnModel();
        TableColumn aColumn = columnModel.getColumn(columnIndex);
        TableCellRenderer renderer;
        if (!readers.containsKey(columnIndex)) {
            ...
            if (renderer == null) {
                renderer = new DefaultTableCellRenderer() {
                    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                        ...
                        header.setBorder(App.border);
                        return header;
                    }
                };
            }
            readers.put(columnIndex, renderer);
        }

        renderer = readers.get(columnIndex);
