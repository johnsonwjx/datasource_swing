...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        module_type_tf = new javax.swing.JTextField();
                ...
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addComponent(module_search_tf, javax.swing.GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE)
                                        .addGap(56, 56, 56)))
        );
        ...
        module_type_tf.setEditable(false);
        ...
        jPanel2Layout.setHorizontalGroup(
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(name_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 315, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                ...
                                                .addContainerGap())
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(service_combo, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(jLabel3)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(module_type_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(jLabel1)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(search_tf, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(jLabel1)
                                        .addComponent(jLabel3)
                                        .addComponent(module_type_tf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );

        main_pnl.add(jPanel2, java.awt.BorderLayout.NORTH);
        ...
        try {
            ...
            if (moduleInfoBean == null) {
                String moduleid = ServiceInvoker.saveModule(null, moduleCatalogBean.getValue("projectcode"), //
                        getModuleName(), desc_tf.getText().trim(), modulealias, jsonData.toString(), null, null);
                try {
                    ServiceInvoker.saveCatalog(moduleCatalogBean.getValue("id"), getModuleName(), null, desc_tf.getText().trim(),//
                ...
                ServiceInvoker.saveModule(moduleInfoBean.getValue("id"), moduleCatalogBean.getValue("projectcode"), getModuleName(),//
                        desc_tf.getText(), null, jsonData.toString(), null, null);
            }
                      ...
                      public void do4ojbs(Object... obj1) {
                          try {
                              ...
                              if (moduleInfoBean != null) {
                                  ...
                                  name_tf.setText(moduleInfoBean.getValue("name"));
                                  desc_tf.setText(moduleInfoBean.getValue("description"));
                                  JsonObject inparamObj = getInputParamObj(moduleInfoBean);
                                  if (inparamObj == null) {
                                      return;
                                  }
                                  ModuleType moduleType = getModuleType();
                                  module_type_tf.setText(moduleType.getName());
    ...
    private javax.swing.JTextField module_type_tf;
    ...
    private void getMainPnl(ModuleType moduleType) {
        if (mainPnl != null) {
            main_pnl.remove((Component) mainPnl);
            mainPnl = null;
        }
