...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(811, 120));
        ...
        jPanel2Layout.setHorizontalGroup(
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(nameLb, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(moduleAliasTf, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(search_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                                .addComponent(search_btn, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                .addGap(145, 145, 145)
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(upLoadDocBtn, javax.swing.GroupLayout.Alignment.TRAILING)
                                                        .addComponent(downLoadDocBtn, javax.swing.GroupLayout.Alignment.TRAILING))))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void save_btnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String modulealias = moduleAliasTf.getText();
        try {
            mainPnl.saveParam(modulename, jsonData);
            docDelegate.save(jsonData);
            if (StringUtils.nullOrBlank(modulealias)) {
                //兼容以前 如果上面界面没设置 ,用以前方法处理
                modulealias = mainPnl.getModuleAlias();
            }
            ...
            if (moduleInfoBean == null) {
                ...
                ServiceInvoker.saveModule(moduleInfoBean.getValue("id"), moduleCatalogBean.getValue("projectcode"), getModuleName(),//
                        descTa.getText(), modulealias, jsonData.toString(), null, null);
            }
        ...
        busyDoing(new Do4objs() {
                      ...
                      public void do4ojbs(Object... obj1) {
                          try {
                              ...
                              String moduleString = ServiceInvoker.getModule(moudleid);
